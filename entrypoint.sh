...
[ -n "${INPUT_JSONREPORT}" ] && PYTEST_ARGS="$PYTEST_ARGS --json-report=${INPUT_JSON_REPORT}"
[ -n "${INPUT_HTMLOUTPUT}" ] && PYTEST_ARGS="$PYTEST_ARGS --html-output=${INPUT_HTML_OUTPUT}"
...
[ -n "${INPUT_XMLREPORT}" ] && PYTEST_ARGS="$PYTEST_ARGS --xml-report=${INPUT_XML_REPORT}"
[ -n "${INPUT_CAPTURESCREENSHOTS}" ] && PYTEST_ARGS="$PYTEST_ARGS --capture-screenshots=${INPUT_CAPTURE_SCREENSHOTS}"
[ -n "${INPUT_SHOULDOPENREPORT}" ] && PYTEST_ARGS="$PYTEST_ARGS --should-open-report=${INPUT_SHOULD_OPEN_REPORT}"
